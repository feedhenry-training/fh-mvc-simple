...
<a href="https://github.com/feedhenry/fh-mvc-simple/tree/v5"> v5 branch</a> will integrate google map to app and demostrate how controller handles user actions such as pin my current locatin on map.
